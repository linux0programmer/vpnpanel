        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="mono"><?php echo htmlspecialchars($row['address']); ?></td>
                    <td class="mono"><?php echo htmlspecialchars($row['gateway']); ?></td>
                    <td><span class="status-pill status-pill--<?php echo $view['pill']; ?>"><?php echo htmlspecialchars($view['text']); ?></span></td>
                    <td>
                        <div class="net-wan-actions">
                            <?php if (!$row['active'] && $row['state'] === 'up'): ?>
