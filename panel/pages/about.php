...
<div class="about-page">
    ...
    <div class="card about-info">
        ...
        <p>
            ...
            компьютеры, телефоны, IP-камеры, принтеры, телевизоры — выходят в интернет через этот сервер,
        ...
        <p>
            ...
            или сетевое оборудование сразу работают через VPN. Ничего не нужно устанавливать на телефоны
    ...
    <div class="about-features">
        ...
        <div class="about-feature">
            ...
            <div class="about-feature-title">Несколько провайдеров</div>
            <div class="about-feature-desc">К серверу можно подключить вторую и третью сетевую карту с разными провайдерами. Каналы выстраиваются по приоритету: если основной перестаёт отвечать, сервер сам переводит трафик на следующий живой и возвращается обратно, когда основной оживёт. Скорость каждого канала можно замерить отдельно, а переключения видны в журнале событий.</div>
        </div>
